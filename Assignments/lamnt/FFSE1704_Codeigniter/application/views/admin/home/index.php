          ...
          <div class="box box-default">
			...
			<div class="box-footer no-padding">
			  <ul class="nav nav-pills d-block nav-stacked">
				<li class="nav-item"><a class="nav-link" href="index.html#">USA
				  <span class="pull-right text-red"><i class="fa fa-angle-up"></i> 12%</span></a></li>				
				<li class="nav-item"><a class="nav-link" href="index.html#">UK
				  <span class="pull-right text-yellow"><i class="fa fa-angle-left"></i> 0%</span></a></li>
				<li class="nav-item"><a class="nav-link" href="index.html#">Japan
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages inner-content-div" id="direct-chat">
                ...
                <div class="direct-chat-msg">
				  ...
				  <!-- /.direct-chat-info -->
				  <img class="direct-chat-img" src="<?=base_url()?>images/user1-128x128.jpg" alt="message user image">
				  <!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
				  ...
				  <!-- /.direct-chat-info -->
				  <img class="direct-chat-img" src="<?=base_url()?>images/user3-128x128.jpg" alt="message user image">
				  <!-- /.direct-chat-img -->
				  <div class="direct-chat-text">
					Lorem Ipsum is...
				  </div>
              ...
              <div class="direct-chat-contacts">
                <ul class="contacts-list">
                  <li>
					<a href="index.html#">
					  <img class="contacts-list-img" src="<?=base_url()?>images/user1-128x128.jpg" alt="User Image">
				  ...
				  <li>
					<a href="index.html#">
					  <img class="contacts-list-img" src="<?=base_url()?>images/user7-128x128.jpg" alt="User Image">
		  ...
		  <div class="box box-danger">
			...
			<div class="box-body no-padding">
			  <ul class="users-list clearfix">
				<li>
				  <img src="<?=base_url()?>images/user1-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Arijit Sinh</a>
				  <span class="users-list-date">Today</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user8-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Sonu Nigam</a>
				  <span class="users-list-date">Yesterday</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user7-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Pavan kumar</a>
				  <span class="users-list-date">12 Jan</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user6-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">John Doe</a>
				  <span class="users-list-date">12 Jan</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user1-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Alexander</a>
				  <span class="users-list-date">13 Jan</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user5-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Angela</a>
				  <span class="users-list-date">14 Jan</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user4-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Maical</a>
				  <span class="users-list-date">15 Jan</span>
				</li>
				<li>
				  <img src="<?=base_url()?>images/user3-128x128.jpg" alt="User Image">
				  <a class="users-list-name" href="index.html#">Juliya</a>
				  <span class="users-list-date">15 Jan</span>
				</li>
			  </ul>
			  <!-- /.users-list -->
				  ...
				  <ul class="products-list product-list-in-box">
					<li class="item">
					  <div class="product-img">
						<img src="<?=base_url()?>images/default-50x50.gif" alt="Product Image">
					  </div>

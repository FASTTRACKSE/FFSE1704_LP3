<?php 
	...
	if(isset($_POST['submit'])){
		...
		$part_upload = $part.'/FFSE1704_LP3/Assignments/SyNV/ass4/images/'.$namenew;
				...
				foreach ($_SESSION as $value) {
					...
					?>
						<tr>
    						...
    						<td> <img style="width: 50px;height: 50px; padding-left: 20px;" src="<?='http://localhost/FFSE1704_LP3/Assignments/SyNV/ass4/images/'.$value['avatar'] ?>"/></td>
    						<td>  <?= $value['gender'] ?> </td>
    						<td>  <?= $value['address'] ?> </td>
    						<td> <a href="">Xoa </a> </td>
						</tr>

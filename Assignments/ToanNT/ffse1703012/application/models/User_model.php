...
public function countAll(){
  return $this->db->count_all("ffse1703012_user");
}
...
{
  return $this->db->get_where('ffse1703012_user',array('id'=>$id))->result_array();
}
public function get_all_user($start,$per_page)
{
  $this->db->limit($per_page,$start);
...
{
   return $this->db->insert('ffse1703012_user',$datas);

...
<head>
    ...
    <!-- BOOTSTRAP STYLES-->
    <link href="http://localhost/FFSE1704_LP3/Assignments/NghiaTD/php-asm-9/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- FONTAWESOME STYLES-->
    <link href="http://localhost/FFSE1704_LP3/Assignments/NghiaTD/php-asm-9/assets/css/font-awesome.css" rel="stylesheet" />
    <!-- CUSTOM STYLES-->
    <link href="http://localhost/FFSE1704_LP3/Assignments/NghiaTD/php-asm-9/assets/css/custom.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            <li class="text-center">
                <img src="http://localhost/FFSE1704_LP3/Assignments/NghiaTD/php-asm-9/assets/img/find_user1.png" class="user-image img-responsive" />
            </li>

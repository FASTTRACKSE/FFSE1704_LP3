...
<a href="<?= base_url() ?>index.php/Admin/User/create"><button type="button" class="btn btn-success" style="float: right; margin-top:-45px;margin-right:385px; border: 1px; ">Add New User</button></a>
		...
		while ($arUS = $result->fetch_assoc()) {
			...
			<tr>
				...
				<td>
					...
					<a href="<?= base_url() ?>index.php/Admin/User/update?id=<?=$arUS['user_id'] ?>&name=<?=$arUS['user_name'] ?>" style="padding-right: 10px;"><span class="glyphicon glyphicon-pencil"></span></a>

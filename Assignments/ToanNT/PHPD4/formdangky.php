...
<form method="POST" enctype="multipart/form-data">
    <table>
        ...
        <tr>
            <td>Tên đăng nhập (*)</td>
            <td><input type="text" name="username" placeholder=" Nhập tên" required></td>
        </tr>
        <tr>
            <td>Mật khẩu (*)</td>
            <td><input type="password" name="password" placeholder=" Nhập password" required></td>
        </tr>
        <tr>
            <td>Họ và tên (*)</td>
            <td><input type="text" name="fullname"  placeholder=" Nhập họ tên"required></td>
        </tr>
        <tr>
            <td>Ảnh đại diện (*)</td>
        ...
        <tr>
            ...
            <td>
                    ...
                    <input type="checkbox" value="Đọc báo" name="favorite[]">Đọc báo <br>
                    <input type="checkbox" value="Du lịch" name="favorite[]">Du lịch
            </td>
        </tr>
        <tr>
            <td></td>
...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if(count($mess)==0){
            ...
            $path_upload= $path_root.'/PHPD4/images/'.$name;

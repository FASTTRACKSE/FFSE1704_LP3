...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 29, 2018 lúc 08:52 AM
...
--
-- Cơ sở dữ liệu: `masinhvien`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `lms_countries`
--
...
--
-- Đang đổ dữ liệu cho bảng `lms_countries`
--
...
--
-- Cấu trúc bảng cho bảng `lms_marks`
--
...
--
-- Đang đổ dữ liệu cho bảng `lms_marks`
--
...
--
-- Cấu trúc bảng cho bảng `lms_students`
--
...
--
-- Đang đổ dữ liệu cho bảng `lms_students`
--
...
--
-- Cấu trúc bảng cho bảng `lms_subjects`
--
...
--
-- Đang đổ dữ liệu cho bảng `lms_subjects`
--
...
(41, 'admin', 'toitenla', '123123', '', ''),
(42, 'lnguyen24794', 'Mr.John123', 'tratienhuongdanang@gmail.com', '123', '26814429_2500273293354449_3045279938832048958_n1.jpg'),
(44, 'lamnt', '123', '123', '123', 'unnamed.jpg'),
(45, 'admin123', 'Mr.John', 'tratienhuongdanang@gmail.com', '123', 'unnamed1.jpg'),
(46, 'admin123124', '123124124', '', '123', '26231706_2056240108032182_8379252041098591206_n.jpg'),
(47, 'lamnt123', 'Mr.John', '123', '123', '26231706_2056240108032182_8379252041098591206_n1.jpg');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `lms_vietnam`
--
...
--
-- Đang đổ dữ liệu cho bảng `lms_vietnam`
--
...
--
-- Chỉ mục cho bảng `lms_countries`
--
ALTER TABLE `lms_countries`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `lms_marks`
--
ALTER TABLE `lms_marks`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `lms_subjects`
--
...
--
-- AUTO_INCREMENT cho bảng `lms_countries`
--
ALTER TABLE `lms_countries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=305;

--
-- AUTO_INCREMENT cho bảng `lms_marks`
--
ALTER TABLE `lms_marks`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `lms_users`
--
ALTER TABLE `lms_users`

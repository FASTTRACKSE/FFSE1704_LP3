...
<head>
    ...
    <!-- BOOTSTRAP STYLES-->
    <link href="http://localhost/ffse1704_php/admin/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- FONTAWESOME STYLES-->
    <link href="http://localhost/ffse1704_php/admin/assets/css/font-awesome.css" rel="stylesheet" />
    <!-- CUSTOM STYLES-->
    <link href="http://localhost/ffse1704_php/admin/assets/css/custom.css" rel="stylesheet" />
    <!-- GOOGLE FONTS-->
